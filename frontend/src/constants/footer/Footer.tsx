...
export const Footer = () => {
  return(<nav id={"footer"}  className={"fixed bottom-0  md:flex md:mb-0\\t  md:text-center  text-white z-[-1] left-0 right-0 md:z-auto md:justify-between rounded-tr-[50px] rounded-tl-[50px] p-1 bg-gradient-to-r from-orange-400 to-rose-400 shadow "}>
